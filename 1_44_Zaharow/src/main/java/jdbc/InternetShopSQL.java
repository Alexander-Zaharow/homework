...
public class InternetShopSQL {
        ...
        private static final String SQL_SELECT_USER = "SELECT * FROM usersIntShop WHERE login=?";
                ...
                while (rs.next()) {
                    switch (SQL) {
                        ...
                        case SQL_SELECT_ALL_BASKET: {
                            ...
                            lines.add(new Basket(login, clothe_id));
                            break;
                        }
        ...
        public static List findBasket (String login) {
            ...
            try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
                ...
                while (rs.next()) {
                    ...
                    basket.add(i, new Basket(login, clothe_id));
                    i++;
                }
